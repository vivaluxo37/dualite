...
export const ContentManagement: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    title: '',
    content_type: 'article' as ContentItem['content_type'],
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      case 'tutorial': return <ImageIcon className="h-4 w-4" />;
      ...
      {showCreateForm && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {editingItem ? 'Update the content item' : 'Add a new content item to the platform'}
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData({ ...formData, content_type: e.target.value as ContentItem['content_type'] })}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="forex, trading, beginner"
                  />
                </div>
              </div>

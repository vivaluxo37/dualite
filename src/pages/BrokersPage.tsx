  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-3xl md:text-4xl font-bold mb-4 tracking-tighter">Compare Forex Brokers</h1>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                    ...
                    <div className="lg:col-span-2">
                      <div className="text-center">
                        ...
                        <Progress value={broker.trust_score} className="mt-2 h-1.5" indicatorClassName={getTrustScoreColor(broker.trust_score)} />
                      </div>
                    </div>
                    ...
                    <div className="lg:col-span-2">
                      <div className="text-center">
                        ...
                        <div className="flex items-center justify-center">
                          ...
                          <span className="font-semibold">{broker.avg_rating.toFixed(1)}</span>
                        </div>

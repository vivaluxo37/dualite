// Performance optimization utilities for broker templates
...
export const createDataCache = <T>(maxSize: number = 100) => {
...
export const optimizeImageLoading = (img: HTMLImageElement) => {
  ...
  // Add error handling
  img.onerror = () => {
    img.src = '/images/placeholder-broker.svg'
    img.alt = 'Broker logo placeholder'
  }

...
exports.generateBrokerTemplate = void 0;
exports.generateAllBrokerTemplates = generateAllBrokerTemplates;
...
const generateBrokerTemplate = (broker) => {
...
exports.generateBrokerTemplate = generateBrokerTemplate;
...
async function generateAllBrokerTemplates() {
    try {
        ...
        const outputDir = path_1.default.join(process.cwd(), 'src', 'pages', 'brokers');
        ...
        for (const broker of brokers) {
            try {
                ...
                await promises_1.default.writeFile(filePath, template, 'utf8');
        ...
        await promises_1.default.writeFile(path_1.default.join(outputDir, 'index.ts'), indexContent, 'utf8');
        console.log('\n📈 Generation Summary:');
